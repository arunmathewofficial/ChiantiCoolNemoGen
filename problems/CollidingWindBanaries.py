...
class ChiantiCoolNemoGen():
    ...
    def __init__(self, ion_list, T_min=1.0E+01, T_max=1.0E+09, ne_min=0.0, ne_max=1.0E+13,
                 make_tab=True, cooling_tab_dir='', make_plot=True, cooling_plot_dir='',
                 IncludeFreeFree=True, IncludeFreeBound=False, IncludeLine=True,
                 Include2photon=True):
        ...
        if cooling_plot_dir is empty:
            return error
        else:
            self.cooling_tab_dir = cooling_tab_dir

        if cooling_tab_dir is empty:
            return error
        else:
            self.cooling_tab_dir
